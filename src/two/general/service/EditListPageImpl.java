...
public class EditListPageImpl implements ICreatePage {
	...
	public void CreatePage(BillBean billBean, PageInfoBean pageBean) {
		GenerateUtil gener=new GenerateUtil();
		String toFile =gener.getFilePath("GeneratePage",billBean.getTablename(),"List_Edit.jsp");//要写入的文件
		String fromfile = gener.getFilePath("modelPage","List_Edit.jsp");//模板文件
		String modelStr =gener.readFile(fromfile);//模板中的内容
		String hasupload=billBean.getHasfileup();//有附件
