...
public class BrowserPageImpl implements ICreatePage {
	...
	public void CreatePage(BillBean billBean, PageInfoBean pageBean) {
		...
		String toFile =gener.getFilePath("GeneratePage",billBean.getTablename(),"Browser.jsp");//要写入的文件
		String fromfile = gener.getFilePath("modelPage","Browser.jsp");//模板文件
