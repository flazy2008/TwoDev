...
// Source File Name:   HrmScheduleDiffDetSignOutManager.java
...
public class HrmScheduleDiffDetSignOutManager extends BaseBean
{
	...
	public List getScheduleList(String s, String s1, int i, int j, int k)
	{
		...
		for (String s23 = s; !flag; s23 = s25)
		{
			...
			stringbuffer.append("  select b.subCompanyId1 as subCompanyId,b.departmentId,b.id as resourceId,b.lastName as resourceName,b.status,max(a.id) as signId ,a.signDate,max(a.signTime) as signTime ").append("   from HrmScheduleSign a,HrmResource b ").append("  where a.userId=b.id ").append("    and a.signDate='").append(s23).append("'").append("    and a.signType='2' ").append("    and a.isInCom='1' ").append("    and a.userType='1' ");
			if (i > 0)
