...
// Source File Name:   HrmScheduleDiffDetNoSignManager.java
	...
	public List getScheduleList(String s, String s1, int i, int j, int k)
	{
		...
		while (!flag2) 
		{
			...
			} else
			{
				...
				stringbuffer.append("   from HrmScheduleSign a,HrmResource b ").append("  where a.userId=b.id ").append("    and a.signDate='").append(s24).append("'").append("    and a.signType='1' ").append("    and a.isInCom='1' ").append("    and a.userType='1' ");
				if (i > 0)
				...
				stringbuffer.append(" )TempTable where signTime<'").append(s23).append(":00' ").append("    and not exists( ").append("       select 1 ").append("       from HrmScheduleSign ").append("      where signDate='").append(s24).append("' ").append("        and signType='2' ").append("        and userType='1' ").append("        and isInCom='1' ").append("        and signTime>'").append(s22).append(":00' ").append("        and userId=TempTable.resourceId ").append("   ) ");
